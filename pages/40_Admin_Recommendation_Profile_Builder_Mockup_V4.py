...
def current_profile_payload(member_label_to_id, clone_label_to_id):
    ...
    return {
        ...
        "region": p.get("region", ""),
        "age_band": clean_choice(p.get("age_band", "")),
        "diet_type": clean_choice(p.get("diet_type", "")),
        "health_concerns": p.get("concerns", []),
        "profile_note": p.get("note", ""),
        ...
        "clone_source_profile_id": clone_label_to_id.get(p.get("clone_from", ""), ""),
        "clone_source_label": p.get("clone_from", "New profile"),
