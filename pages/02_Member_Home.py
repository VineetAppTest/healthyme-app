...
div[data-testid="stHorizontalBlock"]:has(.hm-member-home-balanced-card){display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;align-items:stretch!important;gap:1.5rem!important;}
div[data-testid="stHorizontalBlock"]:has(.hm-member-home-balanced-card) > div[data-testid="column"]{width:100%!important;min-width:0!important;flex:none!important;display:flex!important;align-items:stretch!important;}
div[data-testid="stHorizontalBlock"]:has(.hm-member-home-balanced-card) > div[data-testid="column"] > div[data-testid="stVerticalBlock"]{display:flex!important;flex:1 1 auto!important;flex-direction:column!important;width:100%!important;height:100%!important;}
...
@media(max-width:900px){div[data-testid="stHorizontalBlock"]:has(.hm-member-home-balanced-card){grid-template-columns:1fr!important;gap:1rem!important;}div[data-testid="stHorizontalBlock"]:has(.hm-member-home-balanced-card) > div[data-testid="column"]{display:block!important;}}
</style>
""",
