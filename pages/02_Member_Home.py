...
""", unsafe_allow_html=True)
# v102.2C: optional parallel UX testing links
st.markdown("""
...
with c1:
    if st.button("Recipes-1", key="member_home_recipes_1_v102_2c", use_container_width=True):
        st.switch_page("pages/35_Recipe_Repository_1.py")
with c2:
    if st.button("Exercises-1", key="member_home_exercises_1_v102_2c", use_container_width=True):
