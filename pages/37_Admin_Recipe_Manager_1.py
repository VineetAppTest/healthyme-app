...
require_admin()
utility_logout_bar()
topbar("Recipes-1", "A refreshed meal library and plan workspace inspired by the shared mockup.", "Admin meal library")
st.markdown("""
<style>
...
<div class="hm-rx-page">
  ...
  <div class="hm-rx-layout">
    ...
    <div class="hm-rx-plan">
      ...
      <div class="hm-rx-client"><div class="hm-rx-avatar">M</div><div class="hm-rx-clienttext">Client: Elena R.<br/>Focus: Gentle Digestion & Energy</div></div>
      <div class="hm-rx-drop">Meals and gentle movement appear here when dragged into the plan.</div>
      <div class="hm-rx-actions"><div class="hm-rx-btn secondary">Save Draft</div><div class="hm-rx-btn primary">Finalize Plan</div></div>
    </div>
  </div>
</div>""", unsafe_allow_html=True)
render_page_nav("Recipes-1", back_page="pages/10_Admin_Dashboard.py", dashboard_page="pages/10_Admin_Dashboard.py", show_evaluation=False, show_dashboard=True, location="bottom")
render_back_to_top()
# v102.2E: mockup-aligned admin Recipes-1 page.
