...
st.markdown(
    ...
    <div class='hero-shell'>
      ...
      <div class='hero-kicker'>System Tools · Recommendation diagnostics</div>
      <div class='hero-title'>Repository-to-Profile Builder Source Alignment</div>
      <div class='hero-subtitle'>Checks whether Recipe, Exercise and Supplement source data is being fully represented before member recommendation consumption is built.</div>
      <div><span class='meta-pill'>Contract-first</span></div>
    </div>
    """,
