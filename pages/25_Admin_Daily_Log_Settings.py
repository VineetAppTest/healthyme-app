...
from components.ui_common import inject_global_styles, apply_luxe_theme, topbar, card_start, card_end, utility_logout_bar, render_page_nav
...
if st.button("Reset to Recommended Client Format", use_container_width=True):
    ...
    set_system_message("Repository reset to Breakfast, Lunch, Evening Snack, Dinner and Bedtime.", "success")
    st.rerun()
card_end()
