...
.hm-weekly-toggle-anchor + div [data-testid="stButton"] > button,.hm-weekly-toggle-anchor + div .stButton > button{justify-content:center!important;text-align:center!important;min-height:3.0rem!important;background:#FFFFFF!important;border:1.45px solid #D8A84E!important;border-radius:16px!important;box-shadow:0 8px 18px rgba(15,23,42,.045)!important;color:#064E3B!important;font-weight:950!important;margin:.55rem 0 .34rem 0!important;padding:.64rem .86rem!important;}
.hm-weekly-toggle-anchor + div [data-testid="stButton"] > button *,.hm-weekly-toggle-anchor + div .stButton > button *{color:#064E3B!important;font-size:.92rem!important;font-weight:950!important;line-height:1.22!important;white-space:normal!important;overflow-wrap:normal!important;word-break:normal!important;text-align:center!important;}
.hm-weekly-toggle-body{border:1px solid #E7D8BE;background:#FFFDF8;border-radius:16px;padding:1rem .96rem;margin:.18rem 0 .75rem 0;}
@media(max-width:850px){.hm-rec-card.compact{min-height:auto}.hm-rec-day-label{font-size:.96rem}}
</style>
""",
        unsafe_allow_html=True,
    )
