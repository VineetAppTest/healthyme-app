...
def _apply_daily_log_ui_and_autosave(current_page: str) -> None:
    ...
    st.markdown(
        ...
        html body #root [data-testid="stAppViewContainer"] div[data-testid="stTextInput"] :is([data-baseweb="input"],[data-baseweb="base-input"]){border:1.2px solid #DCC690!important;border-radius:13px!important;background:#FFFFFF!important;box-shadow:none!important;overflow:visible!important;box-sizing:border-box!important;min-height:2.70rem!important;color-scheme:light!important;}
        html body #root [data-testid="stAppViewContainer"] div[data-testid="stTextInput"] input{border:0!important;outline:0!important;box-shadow:none!important;background:#FFFFFF!important;color:#0F172A!important;-webkit-text-fill-color:#0F172A!important;caret-color:#064E3B!important;opacity:1!important;color-scheme:light!important;min-height:2.62rem!important;}
        html body #root [data-testid="stAppViewContainer"] div[data-testid="stTextInput"] input::placeholder{color:#64748B!important;-webkit-text-fill-color:#64748B!important;opacity:1!important;}
