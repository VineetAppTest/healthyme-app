...
APP_BUILD_VERSION = "v102.2B"
APP_BUILD_LABEL = "Recipe1 Exercise1 MemberNav Cleanup"
...
# --------------------------------------------------------------------
# v102.2A Recipe Exercise v93 restoration CSS
# --------------------------------------------------------------------
def inject_recipe_exercise_v1022a_styles():
    st.markdown("""
    <style>
    /* v102.2A restores the v93 Recipe/Exercise visual contract */
    .hm-module-shell{max-width:1120px!important;margin:0 auto!important;padding:.22rem 0 1.5rem 0!important;}
    .hm-content-card{background:#fff!important;border:1px solid #E5D2A9!important;border-radius:18px!important;overflow:hidden!important;box-shadow:0 8px 22px rgba(15,23,42,.06)!important;margin-bottom:.7rem!important;}
    .hm-content-card img{width:100%!important;height:220px!important;object-fit:cover!important;display:block!important;}
    .hm-content-card-body{padding:1rem 1rem .9rem 1rem!important;}
    .hm-content-title{font-family:Georgia,serif!important;color:#064E3B!important;font-size:1.35rem!important;line-height:1.1!important;font-weight:900!important;margin:0 0 .7rem 0!important;}
    .hm-content-meta{display:flex!important;gap:.55rem!important;align-items:center!important;color:#365A45!important;font-weight:700!important;font-size:.92rem!important;}
    .hm-detail-hero{border-radius:22px!important;overflow:hidden!important;border:1px solid #E5D2A9!important;box-shadow:0 10px 26px rgba(15,23,42,.07)!important;margin:.7rem 0 1rem 0!important;}
    .hm-detail-hero img{width:100%!important;height:340px!important;object-fit:cover!important;display:block!important;}
    .hm-detail-title{font-family:Georgia,serif!important;color:#064E3B!important;font-size:2.45rem!important;line-height:1.02!important;font-weight:900!important;margin:.8rem 0 1rem 0!important;}
    .hm-detail-grid{display:grid!important;grid-template-columns:1fr 1fr!important;gap:.8rem!important;margin:.7rem 0 1.15rem 0!important;}
    .hm-detail-pill{background:#FFFDF8!important;border:1px solid #E5D2A9!important;border-radius:18px!important;padding:.9rem 1rem!important;color:#064E3B!important;box-shadow:0 6px 18px rgba(15,23,42,.045)!important;}
    .hm-detail-section-card{background:#fff!important;border:1px solid #E5D2A9!important;border-radius:22px!important;padding:1rem 1.1rem!important;margin-top:.8rem!important;}
    .hm-check-row{display:flex!important;gap:.75rem!important;align-items:flex-start!important;padding:.72rem 0!important;border-bottom:1px solid #EEE3CC!important;color:#064E3B!important;font-size:1.04rem!important;}
    .hm-check-box{width:1.05rem!important;height:1.05rem!important;border:2px solid #6D9C6C!important;border-radius:4px!important;flex:0 0 auto!important;margin-top:.15rem!important;}
    .hm-v1022a-admin-note{border:1px solid #E3C98E;background:#FFF7E6;border-radius:16px;padding:.72rem .86rem;color:#7A5A16;font-size:.86rem;font-weight:760;margin:.35rem 0 .85rem 0;}
    div[data-testid="stTabs"] [role="tab"]{border:1px solid #E3C98E!important;border-radius:999px!important;background:#FFFDF8!important;color:#064E3B!important;font-weight:850!important;padding:.40rem .80rem!important;}
    @media(max-width:768px){.hm-content-card img{height:165px!important}.hm-detail-hero img{height:250px!important}.hm-detail-title{font-size:2rem!important}.hm-detail-grid{grid-template-columns:1fr 1fr!important;gap:.55rem!important}}
    </style>
    """, unsafe_allow_html=True)
