...
class MemberHomeGlobalHeaderRuntimeTests(unittest.TestCase):
    ...
    def test_member_home_controls_root_header_sequence_and_mobile_row(self):
        ...
        self.assertIn("hm-member-home-global-header-v9", rendered_css)
        self.assertIn('stElementContainer"]:has(.hm-member-identity-pill)', rendered_css)
        self.assertIn("hm-member-identity-pill", rendered_css)
        self.assertIn("st-key-hm_top_profile_control", rendered_css)
        self.assertIn("st-key-hm_top_logout_control", rendered_css)
        ...
        self.assertIn('div[data-testid="stColumn"]', rendered_css)
        self.assertIn('div[data-testid="column"]', rendered_css)
        self.assertIn("text-overflow:ellipsis!important", rendered_css)
        self.assertIn("margin:.16rem 0 1rem 0!important", rendered_css)
        self.assertIn("margin-top:.78rem!important", rendered_css)
